...
import { complaintStatusData, customersStatusData, orderStatusData, visitorsStatusData, yearlyEarnings } from "@/lib/constants/pieDiagramsData";
      ...
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <section className="grid grid-cols-1 gap-6">
          ...
          <GraphDiagram
            ...
            yKey="earnings"
            color="#8b5cf6"
            yFormatter={(v: number) => `₹${(v / 1_000).toFixed(0)}k`} // optional
          />
        </section>
