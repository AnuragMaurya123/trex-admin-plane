...
import { MoreHorizontal, Trash2, Edit3, PackageSearch, Eye, PlusCircle } from "lucide-react";
  ...
  if (!products || products.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-80 rounded-xl bg-white dark:bg-slate-800/50 shadow-lg border border-slate-200 dark:border-slate-700">
        ...
        <h3 className="text-xl font-semibold text-slate-700 dark:text-slate-300">No Products Found</h3>
        <ProductDialog
          trigger={
